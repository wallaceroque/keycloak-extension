...
<@layout.mainLayout active='account' bodyClass='user'; section>
    ...
    <form action="${url.accountUrl}" class="form-horizontal" method="post">
        ...
        <div class="form-group">
            <div class="col-sm-2 col-md-2">
            <label for="telefone" class="control-label">${msg("telephone")}</label> <span class="required">*</span>
            </div>

            <div class="col-sm-10 col-md-10">
                <input type="text" class="form-control" id="user.attributes.telephone" name="user.attributes.telephone" value="${(account.attributes.telephone!'')}"/>
            </div>
        </div>
